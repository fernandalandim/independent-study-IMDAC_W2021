const courses = [
    ...
    },
    {
        ...
        code: 'MTM6162',
        level: 1,
        career: ['design', 'video', 'front', 'motion', 'pm']
    },
    {
        index: 5,
    ...
    // Level 4 courses
    {
        ...
        code: 'MTM6460',
        level: 4,
        career: ['design', 'video', 'front', 'back', 'motion', 'pm']
    },
    {
        index: 17,
...
const app = Vue.createApp({
    data: function () {
        return {
            careers: ['UI & UX Designer', 'Video Producer', 'Front-end Developer', 'Back-end Developer', 'Motion Graphics Designer', 'Project Manager'],
            courses: courses,
            sort: 'career',
        }
    },
